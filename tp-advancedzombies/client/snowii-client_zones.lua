...
Citizen.CreateThread(function()
	while true do
		...
		if isInZone then
			...
			LastSafezone                = zone
			TriggerEvent('snowii_advanced-zombies:hasEnteredZone', zone, zoneType, canBlockPlayerAggressiveActions, blockZombiePedSpawning)
		end

		if not isInZone then
			HasAlreadyEnteredMarker = false
			TriggerEvent('snowii_advanced-zombies:hasExitedZone', LastSafezone)
		end
